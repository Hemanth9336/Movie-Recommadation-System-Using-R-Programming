...
setwd("C:/Users/mothu/Documents/movie")
...
#import data set
movies_df <- read.csv("C:/Users/mothu/Documents/movie/movies.csv")
ratings_df <- read.csv("C:/Users/mothu/Documents/movie/ratings.csv")
...
qplot(average_ratings , fill=I("steelblue") , col=I("red"))+
   ggtitle("distribution of the average rating per users")

##normalized rating of top users
...
##heatmap of first row and column
